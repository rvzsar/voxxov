...
<div class="settings">
  ...
  <section>
    ...
    <div class="grid">
      ...
      <label class="full">Шаблон имени<input type="text" value={out.filenameTemplate} oninput={(e) => updateOut({ filenameTemplate: (e.currentTarget as HTMLInputElement).value })} /></label>
    </div>
  </section>
